			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<div class="form-group">
						...
						<div class="col-md-9 col-sm-9 col-xs-12">
							<input id="sistema" type="text" class="form-control text-center" value="Sistema del Dispositivo" disabled>
						</div>
					</div>
					<div class="form-group">
...
@include('admin.activos.radioTrabajo.oficina')
@include('admin.activos.radioTrabajo.vehiculo')
